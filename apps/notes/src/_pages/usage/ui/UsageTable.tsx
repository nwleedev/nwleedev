import type { UsageRow } from "../model/usageProjection"
...
function UsageCountCell({
  ...
  const countClassName = emphasis
    ? "font-display text-base font-bold tabular-nums text-ink"
    : "font-display text-base font-semibold tabular-nums text-ink"
