...
export const TemplateDataContext = createContext<TemplateDataContextValue | null>(
  null,
)
...
export type TemplateDataDependencies = {
...
export function useTemplateDataState({
  clipboard,
  createId,
  now,
  repository,
}: TemplateDataDependencies) {
  ...
  return { ...state, copyText, createTemplate, retry }
}
